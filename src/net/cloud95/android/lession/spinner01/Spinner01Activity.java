package net.cloud95.android.lession.spinner01;
...
public class Spinner01Activity extends Activity {
    ...
    private ArrayAdapter<String> aa01, aa02;//有兩個spinner就會有兩個adapter
    private List<String> listData;
    
    // 在這個Activity元件中的Spinner元件，而且會註冊選擇監聽事件的數量
    private int spinnerCount = 2;//有幾個spinner就設多少
    // 給Spinner當作選項用的字串陣列
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int layoutId01 = android.R.layout.simple_spinner_item;//回傳整數值
        
        // 建立一個選項為String的Adapter物件
        // 第一個參數設定「this」，表示這個Activity元件
        // 第二個參數設定畫面配置資源，決定元件的外觀樣式
        // 第三個參數設定一個字串陣列，提供選項項目資料
        aa01 = new ArrayAdapter<String>(this, layoutId01,arrayData);        
        ...
        aa02 = new ArrayAdapter<String>(this, layoutId02,listData);
